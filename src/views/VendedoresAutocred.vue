...
//   {
    //   "data":"[ { name: 'Jose Lopez', telefono:'56946483871', email: 'jose.lopez@autocred.cl' , id: 1, check:true }, { name: 'Barbara Saavedra', telefono:'56946478330', email: 'barbara.saavedra@autocred.cl' , id: 2 , check:false }, { name: 'Iris Castro', telefono:'56946474281', email: 'iris.castro@autocred.cl' , id: 3 , check:false }, { name: 'Solange Canales', telefono:'56946481460', email: 'solange.canales@autocred.cl' , id: 4 , check:false }, { name: 'Jacky Martinez', telefono:'56932592736', email: 'jacky.martinez@autocred.cl' , id: 5 , check:false }, { name: 'Isis Vivas', telefono:'56946456800', email: 'isis.vivas@autocred.cl' , id: 6 , check:false }, { name: 'Francisco Stemann', telefono:'56946337158', email: 'francisco.stemann@autocred.cl' , id: 7, check:false }, { name: 'Cristian Fernandez', telefono:'56946373862', email: 'cristian.fernandez@autocred.cl' , id: 8, check:false }, { name: 'Carolina Ortiz', telefono:'56946390268', email: 'carolina.ortiz@autocred.cl' , id: 9, check:false }, { name: 'josseline vejar', telefono:'56946453667', email: 'josseline.vejar@autocred.cl' , id: 10, check:false }, { name: 'Felipe Macaya', telefono:'56946439563', email: 'felipe.macaya@autocred.cl' , id: 11, check:false }, { name: 'Valentina Arriaza', telefono:'56946384765', email: 'valentina.arriaza@autocred.cl' , id: 12, check:false }, { name: 'Pablo Farias', telefono:'56946351290', email: 'pablo.farias@autocred.cl' , id: 13, check:false }]"
    // }