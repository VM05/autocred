        ...
        <div class="card shadow-2xl px-6 py-8">
          <Transition>
            <form @submit.prevent="handleForm" v-show="formActive">
              ...
              <div>
                <ProgressBar v-if="useUtms.mobile && activo < 3"  :activo="activo"/>
              </div>
              <div
              ...
              <div class="footer md:grid md:justify-items-center md:align-middle flex flex-row justify-center gap-3 py-4">
                <Button1
                  v-if="activo > 0"
                  text="volver"
                  primary
