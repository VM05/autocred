...
import { empleoType } from "../assets/helpers/API";
...
watch(selected, () => {
  ...
  emit("update:empleo", selected.value.value);
});

const changeEmpleo = (value) => {
  useSimulador.empleo = value;
};
</script>
