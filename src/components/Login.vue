  ...
  <div class="bg-white shadow-xl py-6 px-12 rounded-xl w-fit my-0 mx-auto">
    ...
    <div v-else="!loading">
      ...
      >
        ...
        />
        <Paragraph v-if="errorForm" class="text-red-700 justify-self-center mb-2">
          Rut y/o Contraseña ingresados no son válidos
        </Paragraph>
        <Button1 text="Ingresar" secondary class="justify-self-center w-fit" type="submit" />
        <a :href="PASSWORD_RESET" class="text-primary-900 underline font-semibold text-base">
      ...
      <div class="grid items-center gap-4">
        ...
        <router-link to="/registro" class="justify-self-center w-fit">
          <Button1 text="Crear Cuenta" outlineSecondary class="justify-self-center w-fit" />
        </router-link>
      </div>
    </div>
  </div>
...
<script setup>
  ...
  import { LOGIN_URL, LOGIN_URL_TOKEN, PASSWORD_RESET } from '../assets/helpers/API';
