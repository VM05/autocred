...
export const datosBannerPrincipal = [
...

  {
    ...
    content:
      'La compra y venta de autos usados entre personas particulares es simple con Autocred.',
...
export const datosBannerNuevo = [
  {
    titulo:
      "<span class=' text-secondary-900'>La compra y venta de</span>  autos usados <span class=' text-secondary-900'>entre</span> personas particulares<span class=' text-secondary-900'> es simple con Autocred.</span>",
  ...
  {
    titulo:
      "<span class=' text-secondary-900'>En Autocred hacemos</span> todos los trámites <span class=' text-secondary-900'>por ti</span>",
    content: '¡Evita filas, notarías y malos ratos!',
    img: '/img/imagenBanner/tramites-por-ti.webp',
    buttonText: 'VER TRÁMITES',
    tipo: 'imagen',
  ...
  {
    titulo:
      "100% online,<span class=' text-secondary-900'> Oficina Móvil y Módulos de atención</span>",
...
export const featuresVendedores = [
  {
    name: 'Crédito rápido',
    content: 'En solo 7 minutos evalúa tu crédito con pago al vendedor.',
    img: '/img/icons/Iconos_Autocred_Magenta_Credito_rapido.webp',
  },
  {
    name: 'La mejor cuota',
    content: 'Evaluación directa y en línea con financieras que facilitan tu gestión.',
    img: '/img/icons/Iconos_Autocred_Magenta_Mejor_cuota.webp',
  },
  {
    name: 'Proceso Online o Presencial',
    content: 'Evalúa tu crédito de forma online o acércate a nuestros módulos.',
...
export const cuotasSimulacion = [12, 24, 36, 48];
export const valores = [
  {
    title: 'Libertad',
    content:
      '<b>Vende y compra con toda libertad.</b> Te acompañamos durante todo el proceso. <b>Sin letra chica.</b>',
    src: '/img/valores/icono_transparencia.png',
  },
  {
    title: 'Responsabilidad',
    content:
      'Asumimos la responsabilidad de que la compra o venta de tu auto usado se realice de la forma más transparente y justa.',
    src: '/img/valores/icono_responsabilidad.png',
  },
  {
    title: 'Empatía',
    content:
      'Nos sentamos al lado tanto de compradores como vendedores, entendemos sus necesidades y ofrecemos siempre una solución efectiva.',
    src: '/img/valores/icono_empatia.png',
  },
  {
    title: 'Honestidad',
    content:
      'Somos el mejor copiloto para hacer un buen negocio en la compra y venta de tu auto usado. Entregamos la información necesaria para que ambas partes sepan exactamente el negocio que realizan.',
    src: '/img/valores/icono_honestidad.png',
  },
];
export const questionsComprador = [
  {
    ...
    content:
      '<b>Puedes comprar cualquier tipo de vehículo</b>. El único requisito es que tenga patente registrada.',
  },
  {
    title: '¿En qué me ayuda Autocred para elegir el mejor auto?',
    content:
      'En Autocred queremos que tu compra sea una experiencia extraordinaria, por eso nuestros copilotos estarán para guiarte y apoyarte, resolviendo todas tus dudas sobre transferencias, historial del vehículo, Tag, y con diferentes alternativas de pago o financiamiento.',
  },
  {
    title:
      'Si compro un vehículo usado, ¿Cuáles son los gastos que yo debería incluir, además del valor negociado con el vendedor?',
    content:
      "Además del valor del auto, debes considerar: <ul class='list-disc'><li>Registro Civil</li><ul class='list-disc'><li>Documentos necesarios para la inscripción:</li><ul class='pl-4'><li>CAV (Certificado de Anotaciones Vigentes)</li></ul></ul></li><li>Impuesto 1,5%</li><li>Notaría</li></ul>",
  },
  {
    title: '¿De qué manera puedo pagar el vehículo que me gusta?',
    content:
      'Puedes pagar con tarjeta de crédito/débito, transferencia bancaria y/o crédito automotriz. No recomendamos métodos como vale vista, dinero en efectivo o cheques.',
  },
  {
    title: '¿Cómo hago para ver el auto que quiero de forma acompañada?',
    content:
      '<b>Nuestra Oficina Móvil</b> permite trasladarte en forma gratuita hacia el posible vendedor. Pueden también reunirse en alguno de nuestros puntos de encuentro ubicados en la región Metropolitana (Mall Paseo Quilín, Mall Plaza Norte, Apumanque y Autoselect)',
  },
  {
    title: '¿Cómo solicito un crédito?',
    content:
      "<ul class='list-disc pl-6'><li>Comienza con tu <b>Evaluación en Línea</b> mediante nuestro formulario de financiamiento</li><li>Acercarte a nuestros <b>Módulos Presenciales</b></li><li>Pide asesoría a nuestros <b>Ejecutivos Online</b> los 7 días de la semana.</li></ul>",
  },
  {
...
export const comentarios = [
  ...
  },
  {
    ...
    comentario:
      'Excelente experiencia con Autocred, Carolina muy atenta y flexible en las necesidades horarias para concretar transferencias, recomendable la plataforma, empresa y ejecutiva.',
    src: '/img/icons/Iconos_Autocred_Azul_Copiloto.webp',
  },
  {
    nombre: 'José Valdés',
    ...
    comentario:
      'Quiero destacar y felicitar a la empresa Autocred, y su personal, que me ayudaron una enormidad en una compra urgente que tuve que realizar. Todo se realizó en un par de horas, entregándome seguridad, confianza en la compra y sin poner en riesgo mi dinero. Felicitaciones y 100% recomendado Autocred.',
    src: '/img/icons/Iconos_Autocred_Azul_Copiloto.webp',
  },
  {
...
export const rrss = [
  {
    name: 'facebook',
    url: 'https://www.facebook.com/autocredcl',
    src: '/img/rrss/rrss-facebook.svg',
  },
  {
    name: 'instagram',
    url: 'https://www.instagram.com/autocredcl/',
    src: '/img/rrss/rrss-instagram.svg',
  },
  {
    name: 'linkedIn',
    url: 'https://www.linkedin.com/company/autocredcl/',
    src: '/img/rrss/rrss-linkedin.svg',
  },
];
...
export const newFeaturesSeguro = [
  {
    name: '',
    content: "<span class='md:w-3/4 block font-semibold'>Seguro automotriz para siniestros</span>",
    img: '/img/nuevos-servicios/Icono-Seguro02.webp',
  },
  {
    name: '',
    content: "<span class='md:w-3/4 block font-semibold'>Proceso 100% online</span>",
    img: '/img/nuevos-servicios/icono-transferencia-03.webp',
  },
];
...
export const featuresFinanciamiento = [
  {
    name: 'Crédito rápido',
    content: 'Gestiona tu crédito en solo 7 minutos.',
    img: '/img/icons/Iconos_Autocred_Blanco_Credito_rapido.png',
  },
  {
    name: 'Proceso online',
    content: 'Nuestros copilotos te guiarán a través del canal digital.',
...
export const featuresTag = [
  ...
  },
  {
    ...
    content: 'Nuestros copilotos te apoyarán permanentemente con todas tus dudas.',
...
export const posts = [
  {
    id: 1,
    title:
      'Nueva ley para los deudores de pensiones alimenticias y su relación con la compra y venta de vehículos usados',
...

  {
    id: 2,
    title:
      'Viernes de emprendedores con Felipe Lira, Socio Fundador de Autocred habla sobre el mercado automotriz de autos usados.',
...

  {
    id: 6,
    title:
      'Entrevista en Radio Biobío Felipe Lira, Socio Fundador de Autocred habla sobre el mercado automotriz de autos usados.',
  ...
  },
  {
    id: 7,
    title:
      'Programa Emprender es Clave de Radio La Clave, Felipe Lira Socio Director habla sobre Autocred y la compra o venta de autos usados',
...
export const nuevaDataServicios = [
  {
    ...
    content:
      'Gestionamos la transferencia de dominio de un vendedor particular a un comprador particular en sólo 20 minutos. ¡Sin filas en notaría y Registro Civil!',
  ...
  },
  {
    ...
    content:
      'Compra un vehículo usado a un vendedor particular con tarjeta de débito, crédito o transferencia bancaria',
...
export const dataServicios = [
  ...
  },
  {
    ...
    title: 'Servicio de seguro automotriz',
    content:
      'Con Autocred asegura tu vehículo al realizar la transferencia a través de nuestros módulos, Oficina Móvil o vía online.',
...
export const serviciosVendores = [
  {
    ...
    content:
      "¿Quieres compañía cuando muestras el vehículo? <br> Utiliza nuestra <b>Oficina Móvil</b> para moverte junto al potencial comprador: <br> <ul class='list-disc pl-6'><li>Transferencias</li><li>Pagos con tarjetas</li><li>Servicio de Van 100% gratis</li><li>Financiamiento en solo 7 minutos</li></ul>",
...
export const newCardDataCompradores = [
  {
    ...
    content:
      'Evalúa tu crédito automotriz en sólo 7 minutos en nuestro evaluador online. Puedes hacer el pago del monto que tienes disponible, para la compra de auto usado a un vendedor particular con tarjeta de débito, crédito o transferencia bancaria.',
    img: '/img/icons/Iconos_Autocred_Blanco_Financiamiento.png',
    cardNumber: 0,
  },
  {
...
export const newCardDataVendedores = [
  {
    ...
    content:
      'Transfiere tu auto usado a un comprador particular con nosotros, ¡Lo hacemos en línea con el Registro Civil! Evitándote largas filas. Solicita nuestro servicio de transferencia de forma online, presencial de nuestros módulos u Oficina Móvil',
    img: '/img/nuevos-servicios/Icono-Transferencia-de-dominio-02.webp',
    cardNumber: 3,
  },
  {
...
export const beneficios = [
  {
    content:
      " <p class='text-primary-900  '>Tus colaboradores podrán hacer la <span class='font-bold'>evaluación de su crédito en solo 7 minutos con su Rut</span></p>",
  },
  {
    content:
      "<p class='text-primary-900  '>20% de descuento en</p><ul class='  text-primary-900'><li><span class='check-icon inline-block'></span> <span class='font-bold'>Tasas de interés</span> para socios y grupo familiar.</li><li><span class='check-icon inline-block'></span><span class='font-bold'>Servicio de administración</span> por transferencia de dominio</li></ul>",
  },
  {
    content:
      "<p class='text-primary-900'>Pago del monto financiado al vendedor <span class='font-bold'>al recibir el pago del pie</span> del comprador y firma del contrato de transferencia</p>",
  },
  {
    content:
      "<p class='text-primary-900   grow'>Ejecutivo de atención <span class='font-bold'>dedicado 8x7</span></p>",
  },
  {
    content:
      "<p class='text-primary-900'>Garantía mecánica por 1 año gratis,<br><span class='font-bold'>contratando el Seguro automotriz HDI</span></p>",
  },
  // {
...
export const canalesAtencion = [
  ...
  },
  {
    ...
    content:
      '  <span class="font-bold">Oficina Móvil</span> - Vamos a donde quieras dentro de la RM',
  },
];
