    ...
    routes: [
        {
            ...
            children: [
                ...
                { path: '/convenio-empresas', name: 'servicioconvenio-empresas', component: () => import('../views/B2B.vue') },
                {
                ...
                { path: '/nuevo-simulador', name: 'nuevo-simulador', component: () => import('../views/SimuladorPrueba.vue') },
